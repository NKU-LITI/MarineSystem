...
def waterSystem():
    ...
    fish_weight = source.TotalWeight
    ...
    return render_template('waterSystem.html', title='水下系统', data=data, legend=[i.get('name') for i in data], 
                           ...
                           total_count=total_count, fish_weight = fish_weight, growth_count= growth_count, no_growth_count = no_growth_count, fish_species = fish_species)
